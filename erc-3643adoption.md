...
| Metric                                      | Description                                                                                                                                 |
| ------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- |
| Number of Deployed Token Contracts                | Count of token contracts on the Ethereum Mainnet, Polygon Mainnet and Avalanche that are verified to implement the ERC3643 standard.                                       |
